...
|-----------|------------------------------------|--------------|
| Алексюнина Ю.В. | Подготовка датасета, обучение полносвязной нейронной сети, напичание отчёта  |          |
| Бондарь К.Г. | Подготовка датасета, обучение свёрточной нейронной сети, написание отчёта |       |
| Лопатин А.О.| Подготовка датасета, обучение полносвязной нейронной сети, обучение свёрточной нейронной сети |      |
